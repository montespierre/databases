...
CREATE TABLE `detalle_ventas` (
  `IdDetalleVentas` varchar(0) DEFAULT NULL,
  `IdVentas` varchar(0) DEFAULT NULL,
  `IdProducto` varchar(0) DEFAULT NULL,
  `Cantidad` varchar(0) DEFAULT NULL,
  `PrecioVenta` varchar(0) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `empleado` (
  `IdEmpleado` tinyint(4) DEFAULT NULL,
  `Dni` smallint(6) DEFAULT NULL,
...
INSERT INTO `producto` VALUES (1,'Teclado Logitech 345 Editado',150.0,99,1),(2,'Mouse Logitech 567',20.0,98,1),(3,'Laptop Lenovo Ideapad 520',800.0,100,1),(4,'HeadPhones Sony M333',500.0,98,1),(7,'Producto Nuevo w',22.0,35,1);
...
CREATE TABLE `ventas` (
  `IdVentas` varchar(0) DEFAULT NULL,
  `IdCliente` varchar(0) DEFAULT NULL,
  `IdEmpleado` varchar(0) DEFAULT NULL,
  `NumeroSerie` varchar(0) DEFAULT NULL,
  `FechaVentas` varchar(0) DEFAULT NULL,
  `Monto` varchar(0) DEFAULT NULL,
  `Estado` varchar(0) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
